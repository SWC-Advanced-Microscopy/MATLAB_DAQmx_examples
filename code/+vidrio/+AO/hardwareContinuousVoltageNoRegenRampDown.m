function hardwareContinuousVoltageNoRegen
    ...
    taskName = 'hardAO5';    % A string that will provide a label for the task
    ...
    waveform=sin(linspace(-pi,pi, sampleRate*4))'*5; % Build one cycle of a sine wave to play through the AO line. NOTE: column vector
    ...
    try
        ...
        hTask.registerEveryNSamplesEvent(@topUpBuffer, 200);
