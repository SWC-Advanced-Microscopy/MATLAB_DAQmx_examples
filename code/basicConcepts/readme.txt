...
Those examples are somewhat abstract and it may not be clear what advantage object-oriented programming
provides. The following example illustrates a simple use case that would be hard to create without OO:
